...
gi2018_days %>% 
    filter(date == as_date("2018-09-17")) %>%
    ungroup() %>%
    count(screen_name) %>% 
    arrange(desc(n)) %>%
    slice(1:20) %>% 
    ggplot(aes(reorder(screen_name, n), n)) +
        ...
        coord_flip() +
        labs(x = "Screen Name", y = "Tweets",
             title = "#gi2018 tweets by user, Day 1",
             subtitle = "top 20 users") + 
        theme(axis.text = element_text(size = 12),
              axis.title = element_text(size = 12))
```
...
gi2018_days %>% 
    filter(date == as_date("2018-09-18")) %>%
    ungroup() %>%
    count(screen_name) %>% 
    arrange(desc(n)) %>%
    slice(1:20) %>% 
    ggplot(aes(reorder(screen_name, n), n)) +
        ...
        coord_flip() +
        labs(x = "Screen Name", y = "Tweets",
             title = "#gi2018 tweets by user, Day 2",
             subtitle = "top 20 users") + 
        theme(axis.text = element_text(size = 12),
              axis.title = element_text(size = 12))
```
...
gi2018_days %>% 
    filter(date == as_date("2018-09-19")) %>%
    ungroup() %>%
    count(screen_name) %>% 
    arrange(desc(n)) %>%
    slice(1:20) %>% 
    ggplot(aes(reorder(screen_name, n), n)) +
        ...
        coord_flip() +
        labs(x = "Screen Name", y = "Tweets",
             title = "#gi2018 tweets by user, Day 3",
             subtitle = "top 20 users") + 
        theme(axis.text = element_text(size = 12),
              axis.title = element_text(size = 12))
```
