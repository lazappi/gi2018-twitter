...
1260 tweets were collected using the `rtweet` R package:
...
#gi2018 </td>
  ...
  <tr>
   ...
   <td style="text-align:left;"> V interesting work from Guillaume Gautreau on pangenome graphs, from sequence level to genome organisation. Advocating use of a pan-genome ref.  If you liked that see (my student) @rmcolq talk on Thursday about nanopore or illumina SNP/indel calling using pg references #GI2018 </td>
...
https://t.co/GoG64RH9zP https://t.co/FmvYSnWTlr </td>
  ...
  <tr>
   ...
   <td style="text-align:left;"> KP: Importance of balancing training data in ML to the biology. E.g., imagine the biology suggests that most examples are TNs. If you then have balanced TP and TN in the training and test sets, then your estimated accuracy will be overstated wrt the true biology. #gi2018 </td>
